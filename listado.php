                    ...
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope='col'><input class='btn btn-primary' type='submit' name='btnEliminar' value='Eliminar' /></th>
                             <th scope='col'><input class='btn btn-primary' type='submit' name='btnModificar' value='Modificar modo de usuario' /></th>
                        </tr>
                    </thead>
                    <?php
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                <li class="page-item <?php echo $pagina == 1 ? 'disabled' : '' ?>">
                                    <a class="page-link" href="listado.php?pagina=<?php echo $pagina - 1; ?>" aria-label="Previous">
                                ...
                                ?>
                                    <li class="page-item <?php echo $pagina == $i ? 'active' : '' ?>"><a class="page-link" href="listado.php?pagina=<?php echo ($i); ?>"><?php echo ($i); ?></a></li>
                                <?php }  ?>

                                <li class="page-item <?php echo $pagina < $paginacion ? 'disabled' : '' ?>">
                                    <a class="page-link" href="<?php if ($pagina>=$paginacion) {
                                        # code...
                                    }else{ echo 'listado.php?pagina'; }?>" aria-label="Next">
