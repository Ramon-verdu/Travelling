    ...
    <ul class="dropdown-menu">
      ...
      <li><a class="dropdown-item" href="logout.php">salir de la cuenta</a></li>
        ...
        <div class="container" style="margin-top: 14%;">
            <form action="mandartrabajoT.php" method="post" name="f1">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                <li class="page-item <?php echo $pagina == 1 ? 'disabled' : '' ?>">
                                    <a class="page-link" href="tutrabajoT.php?pagina=<?php echo $pagina - 1; ?>" aria-label="Previous">
                                ...
                                ?>
                                    <li class="page-item <?php echo $pagina == $i ? 'active' : '' ?>"><a class="page-link" href="tutrabajoT.php?pagina=<?php echo ($i); ?>"><?php echo ($i); ?></a></li>
                                <?php }  ?>

                                <li class="page-item <?php echo $pagina < $paginacion ? 'disabled' : '' ?>">
                                    <a class="page-link" href="<?php if ($pagina>=$paginacion) {
                                        # code...
                                    }else{ echo 'tutrabajoT.php?pagina'; }?>" aria-label="Next">
